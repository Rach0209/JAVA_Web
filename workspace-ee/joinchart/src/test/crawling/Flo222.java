...
public class Flo222 {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < 100; i++) {
			...
			if(String.valueOf(artistList.get(i).findValues("name")).replaceAll("[\\[\"\\]]", "").contains(",")) {
				titletempList.remove(titleList.get(0).findValues("artistList").get(i+1).findValue("name"));
			}
		}
		...
		for (int i = 0; i < 100; i++) {
			...
			System.out.println(flolist.get(i));
		}
	}
}
